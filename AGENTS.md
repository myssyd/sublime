...
- Keep collection pages visually simple. For image-led cards, prefer the image with a concise label overlay and a subtle image zoom; avoid extra badges, descriptions, metadata, or card movement unless essential.
